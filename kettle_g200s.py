...
# key param is a random string 'ffffffffffffffff'. Remember it for following requests to the kettel
# kettle_g200s.py --mac '12:12:12:12:12' --key '<random key for auth>' --command 'ON'
# kettle_g200s.py --mac '12:12:12:12:12' --key '<random key for auth>' --command 'OFF'
# kettle_g200s.py --mac '12:12:12:12:12' --key '<random key for auth>' --command 'GET_MODE'
# kettle_g200s.py --mac '12:12:12:12:12' --key '<random key for auth>' --command 'STAT_COUNTS'
# kettle_g200s.py --mac '12:12:12:12:12' --key '<random key for auth>' --command 'STAT_WATTS'
# commands SET_MODE and KEEP_TEMP doesn't work yet...
